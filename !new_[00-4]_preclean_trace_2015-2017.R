# ==================================================================================================
# [0-4] THIS PIECE CLEANS 2015-2017 DATA
#  - ABOUT 15 MINUTES  
# ==================================================================================================
...
# --------------------------------------------------------------------------------------------------
# Do Dick-Nielsen filtering for 2015-2017
# --------------------------------------------------------------------------------------------------

## read data
trace12 = fread(input = './data_input/trace_2015-2017.csv', header = T, stringsAsFactors = F)
gc()
trace12[,irow := .I]
gc()
...
## save file
#fwrite(trace12, './data_input/trace_2015-2017_clean.csv')
trace_15_17 = trace12
remove(trace12)
save(trace_15_17, file= './data_input/trace_15_17.RData')