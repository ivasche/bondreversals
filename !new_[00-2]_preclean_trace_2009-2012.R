# ==================================================================================================
# [0-2] THIS PIECE CLEANS 2009-2012 DATA
#  - ABOUT 15 MINUTES  
# ==================================================================================================
...
# --------------------------------------------------------------------------------------------------
# Do Dick-Nielsen filtering for 2009-2012
# --------------------------------------------------------------------------------------------------

## read data
trace12 = fread(input = './data_input/trace_2009-2012.csv', header = T, stringsAsFactors = F)
trace12[,irow := .I]
...
## save file
#fwrite(trace12, './data_input/trace_2009-2012_clean.csv')
trace_09_12 = trace12
remove(trace12)
save(trace_09_12, file= './data_input/trace_09_12.RData')