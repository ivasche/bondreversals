# ==================================================================================================
# [0-3] THIS PIECE CLEANS 2012-2014 DATA
#  - ABOUT 15 MINUTES  
# ==================================================================================================
...
# --------------------------------------------------------------------------------------------------
# Do Dick-Nielsen filtering for 2012-2014
# --------------------------------------------------------------------------------------------------

## read data
trace12 = fread(input = './data_input/trace_2012-2014.csv', header = T, stringsAsFactors = F)
trace12[,irow := .I]
...
trace12[, c('irow', 'wis_fl', 'trdg_mkt_cd', 'spcl_trd_fl', 'scrty_type_cd', 'sale_cndtn_cd',
            'buy_cmsn_rt', 'sell_cmsn_rt', 'cmsn_trd', 'msg_seq_nb', 'asof_cd', 'trc_st',
            'buy_cpcty_cd', 'sell_cpcty_cd', 'cntra_mp_id') := NULL]
...
## save file
#fwrite(trace12, './data_input/trace_2012-2014_clean.csv')
trace_12_14 = trace12
remove(trace12)
save(trace_12_14, file= './data_input/trace_12_14.RData')