# ==================================================================================================
# [0-6] THIS PIECE CLEANS 2019-2020 DATA
#  - ABOUT 15 MINUTES  
# ==================================================================================================
...
# --------------------------------------------------------------------------------------------------
# Do Dick-Nielsen filtering for 2019-2020
# --------------------------------------------------------------------------------------------------

## read data
trace12 = fread(input = './data_input/trace_2019-2020.csv', header = T, stringsAsFactors = F)
trace12[,irow := .I]
...
# leave only up to 2020
trace12 <- delete(trace12, keep.idxs = which(trace12$trd_exctn_dt <= 20201231))

## save file
#fwrite(trace12, './data_input/trace_2019-2020_clean.csv')
trace_19_20 = trace12
remove(trace12)
save(trace_19_20, file= './data_input/trace_19_20.RData')
